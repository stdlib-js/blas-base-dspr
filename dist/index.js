...
var M=require('@stdlib/blas-base-assert-is-layout/dist'),_=require('@stdlib/blas-base-assert-is-matrix-triangle/dist'),O=require('@stdlib/strided-base-stride2offset/dist'),c=require('@stdlib/error-tools-fmtprodmsg/dist'),B=x();function C(i,r,e,v,n,a,m){var t;if(!M(i))throw new TypeError(c('203Fx',i));if(!_(r))throw new TypeError(c('203Fy',r));if(e<0)throw new RangeError(c('203Fz',e));if(a===0)throw new RangeError(c('203GB',a));return e===0||v===0?m:(t=O(e,a),B(i,r,e,v,n,a,t,m,1,0))}V.exports=C
});var j=d(function(N,R){
var D=require('@stdlib/blas-base-assert-is-layout/dist'),G=require('@stdlib/blas-base-assert-is-matrix-triangle/dist'),p=require('@stdlib/error-tools-fmtprodmsg/dist'),H=x();function I(i,r,e,v,n,a,m,t,s,y){if(!D(i))throw new TypeError(p('203Fx',i));if(!G(r))throw new TypeError(p('203Fy',r));if(e<0)throw new RangeError(p('203Fz',e));if(a===0)throw new RangeError(p('203GB',a));if(s===0)throw new RangeError(p('203GS',s));return e===0||v===0?t:H(i,r,e,v,n,a,m,t,s,y)}R.exports=I
